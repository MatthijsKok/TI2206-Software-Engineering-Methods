...
/**
 * The playerzzz class represents a real life person. It handles input,
...
public class Player implements Observer {
    ...
    /**
     * The character this playerzzz observes. Changes each level.
     */
    private Character character = null;

    /**
     * Creates a new playerzzz instance with the keys.
