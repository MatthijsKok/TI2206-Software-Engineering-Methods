...
public class MainMenu extends Pane {
    ...
    static {
        DEFAULT_LEVELS.add("level1.json");
        DEFAULT_LEVELS.add("level2.json");
        DEFAULT_LEVELS.add("level3.json");
        DEFAULT_LEVELS.add("level4.json");
        DEFAULT_LEVELS.add("level5.json");
    }
