...
public final class LogLevel {
    ...
    /**
     * The OFF LogLevel has the highest possible rank
    ...
    /**
     * The FATAL LogLevel designates very severe error
     * events that will presumably lead the application to abort.
     */
    public static final LogLevel FATAL = new LogLevel("FATAL", 1000);
    /**
     * The ERROR LogLevel designates error events that
    ...
    /**
     * The INFO LogLevel designates informational messages that
     * highlight the progress of the application at coarse-grained level.
     */
    public static final LogLevel INFO  = new LogLevel("INFO", 700);
    /**
     * The DEBUG LogLevel designates fine-grained informational
     * events that are most useful to debug an application.
     */
    public static final LogLevel DEBUG = new LogLevel("DEBUG", 600);
    /**
     * The TRACE LogLevel designates finer-grained informational
     * events than the DEBUG LogLevel.
     * Mostly used in loops.
     */
    public static final LogLevel TRACE = new LogLevel("TRACE", 500);
    /**
     * The ALL level has the lowest possible rank and is intended
     ...
     * @param value The value is used to determine if this
